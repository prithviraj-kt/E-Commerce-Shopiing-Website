            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                <div className="flex">
                  ...
                  {Object.keys(varients).includes("orange") &&
                    Object.keys(varients["orange"]).includes(size) && (
                      <button
                        onClick={() => {
                          refreshVarient(size, "orange");
                        }}
              ...
              <div className="pin mt-6 space-x-2 text-sm">
                <input
                  ...
                  className="border-2 rounded-md p-2 border-grey-500"
                  type="text"
                />
                <button
              ...
              {!service && service != null && (
                <div className="text-red-500 text-sm mt-3">
                  Sorry! We do not deliver to this pin
                </div>
              )}
              {service && service != null && (
                <div className="text-green-500 text-sm mt-3">
                  This pincode is available to deliver
                </div>
              )}
            </div>
          </div>
