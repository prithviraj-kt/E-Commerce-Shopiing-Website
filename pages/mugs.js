    ...
    <div>
      {Object.keys(products).length == 0 && (
        <div className="h-[100vh] flex align-center justify-center">
          <h1 className=" text-2xl">Oops! We are out of stock</h1>
        </div>
      )}
      {Object.keys(products).length > 0 && (
                    ...
                    <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="mt-1">
                          ...
                          {/* <div>
                          Colors:{" "}
                          {products[item].color.toString().includes("red") && (
                            <button className="border-2 border-red-300 ml-1 bg-red-700 rounded-full w-6 h-6 focus:outline-none"></button>
                          )}
                          {products[item].color.toString().includes("blue") && (
                            <button className="border-2 border-blue-300 ml-1 bg-blue-700 rounded-full w-6 h-6 focus:outline-none"></button>
                          )}
                          {products[item].color
                            .toString()
                            .includes("green") && (
                            <button className="border-2 border-green-300 ml-1 bg-green-700 rounded-full w-6 h-6 focus:outline-none"></button>
                          )}
                          {products[item].color
                            .toString()
                            .includes("yellow") && (
